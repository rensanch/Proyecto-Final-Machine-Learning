...
Ahora seleccionaremos los mejores hiperparámetros, para **Random Forest** fueron: mtry = 10, trees = 100 y min_n = 10; mientras que para **Decision Tree** fueron: cost_complexity = 0.001, tree_depth = 1 y min_n = 2.
...
kappa_values <- tibble(
  ...
  Kappa = c(
    ...
    metrics_rf %>% filter(.m etric == "kap") %>% pull(.estimate),
